...
response.logo = A(B('Policia de Catamarca -Sistema Patrimonial',SPAN(),''),XML(''),
                  _class="brand",_href="")
response.title = 'Sistema de Partes de Novedades'
response.subtitle = 'Ver_1.0'
...
def _():
    ...
    ### MENU MIO
    #response.menu = [(SPAN(I(_class=' icon-user icon-white'), B(' Adm. Usuarios')),False,URL(c='registro', f='miregistro')),]
...
if auth.is_logged_in():
  response.menu += [(SPAN(I(_class='glyphicon glyphicon-home'), B(' Panel Principal')),False,URL(c='default', f='principal')),
